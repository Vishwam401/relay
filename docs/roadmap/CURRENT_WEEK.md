...
**Progress:** Din 1 complete (schema + migration). Next: **Din 2 — `POST /jobs` and `GET /jobs/{id}`**.
...
| **Week 1** | [`planning/WEEK_01.md`](../planning/WEEK_01.md) | [`logs/WEEK_01.md`](../logs/WEEK_01.md) | 🔄 **Din 1 done** |
